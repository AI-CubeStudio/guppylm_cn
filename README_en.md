...
<p align="center">
  <strong>English</strong> · <a href="README.md">简体中文</a> · <a href="docs/GUIDE_zh.md">📖 使用指南</a>
</p>
...
**[arman-bd/guppylm-60k-generic](https://huggingface.co/datasets/arman-bd/guppylm-60k-generic)** on HuggingFace · China mirror: **[hf-mirror.com/datasets/arman-bd/guppylm-60k-generic](https://hf-mirror.com/datasets/arman-bd/guppylm-60k-generic)**
...
If HuggingFace is slow or unreachable, set `HF_ENDPOINT` before downloading:
...
| Resource | HuggingFace | China mirror |
|---|---|---|
| Dataset | [guppylm-60k-generic](https://huggingface.co/datasets/arman-bd/guppylm-60k-generic) | [guppylm-60k-generic](https://hf-mirror.com/datasets/arman-bd/guppylm-60k-generic) |
| Model | [guppylm-9M](https://huggingface.co/arman-bd/guppylm-9M) | [guppylm-9M](https://hf-mirror.com/arman-bd/guppylm-9M) |
